    ...
    <div className="w-screen h-screen bg-gray-100 p-8">
      <LayoutGroup>
        <div className="flex flex-col h-full w-full">
          <div className="flex-1 flex flex-col justify-center items-center px-[150px]">
            <div className="text-gray-600 text-2xl max-w-[1200px] leading-relaxed mb-12 text-left self-start pl-[200px]">
              Your portfolio is up{" "}
              <span className="font-bold text-green-600">4.24%</span> this week,
              with strong performance from crypto holdings. You have{" "}
              <span className="font-bold text-gray-800">3 active alerts</span>{" "}
              and{" "}
            ...
            <div className="h-[300px] w-full max-w-[1200px] grid grid-cols-5 grid-rows-1 gap-6">
              <div className="col-span-1 row-span-1 group cursor-pointer">
                <motion.div
                  layoutId="profit-widget"
                  onClick={() => setSelectedWidget("profit-widget")}
                  className="bg-white border border-gray-200 rounded-2xl p-6 transition-all duration-300 relative overflow-hidden"
                >
                ...
                <div className="h-0 group-hover:h-8 bg-gray-200 transition-all duration-300 overflow-hidden rounded-b-2xl flex items-center justify-center">
          ...
          <div className="pb-8 flex justify-center">
            <div
              className={`h-12 w-[300px] bg-white rounded-2xl p-2 relative ${
                isThinking
