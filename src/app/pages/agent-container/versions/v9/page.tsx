...
export default function AgentContainer() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center bg-gradient-to-b to-[#DCC4C4] from-[#A0AADA] relative perspective-midrange">
      <div className="w-full flex flex-col items-center sticky top-0 px-2 py-2 bg-white/20 backdrop-blur-2xl">
        <motion.div
