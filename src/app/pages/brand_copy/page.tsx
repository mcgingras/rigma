...
const BrandPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full h-[60px] bg-gray-100 border-b border-gray-300 flex flex-row items-center justify-center">
        ...
        {isOpen && (
          <motion.div
            layoutId="ambush-a-container"
            className="absolute bottom-8 right-8 border border-gray-100 rounded-lg p-2 flex flex-row space-x-2 shadow-sm bg-white"
            onMouseLeave={() => setIsOpen(false)}
          >
            <div className="relative flex flex-col items-center justify-center bg-gradient-to-t from-gray-100 to-[#F4E7C1] rounded-lg py-8 w-[200px]">
              <img
                src="/assets/side.png"
                alt="Ambush A"
                className="w-12 h-12"
            ...
            <div className="flex flex-col space-y-2 items-center justify-end">
              <motion.div
                layoutId="ambush-a"
                className="flex flex-col items-center justify-center bg-gray-300 rounded-lg p-2 self-end"
              >
                <img
                  src="/assets/ambush_a.svg"
                  alt="Ambush A"
