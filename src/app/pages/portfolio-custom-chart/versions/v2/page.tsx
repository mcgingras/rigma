        ...
        {intervals.map((interval: any, index: any) => {
          ...
          return (
            <motion.div
              ...
              key={index}
              className="absolute left-0 top-0 block h-full bg-gray-2"
            ...
            >
              <motion.div
                ...
                className="absolute left-0 bg-accent-9"
                style={{
                  height: interval.height,
                  top: interval.offset,
                }}
        ...
        <AnimatePresence>
          {tooltipInfo && (
            <motion.div
              ...
              className="pointer-events-none absolute z-30 rounded bg-gray-9 px-2 py-1 text-xs font-medium text-white shadow-lg"
              style={{
